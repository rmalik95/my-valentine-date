...
# Start the dev server — it auto-reloads as you make changes
npm run dev
```
...
This project is kept intentionally lightweight and modern:

- **Vite** — blazing fast build tool and dev server
- **React** — the UI library powering the interactive experience
- **TypeScript** — adds type safety so things don't break in sneaky ways
- **Tailwind CSS** — utility-first styling that keeps the code clean and the design crisp
- **shadcn/ui** — a handy set of accessible, reusable UI components

---

## ✨ Why This Project Exists

Not everyone expresses their feelings the same way — and that's a good thing. If grand gestures aren't your style but you still want to do something a little extra this Valentine's season, a personalised website is a surprisingly thoughtful way to do it.

It's simple, it's fun, and it shows you put a bit of effort into making the moment memorable. Feel free to fork it, make it your own, and send it to that special someone. 💝
